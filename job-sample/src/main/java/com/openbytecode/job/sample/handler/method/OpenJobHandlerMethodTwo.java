...
public class OpenJobHandlerMethodTwo {
    ...
    @JobHandler(value = "job-method-two1", name = "方法任务处理器two1")
    public void handlerTwo1(JobHandlerParam jobParam) {
        log.info("JobHandlerOne 处理任务, 任务参数 {}", jobParam.getParams());
    }

    @JobHandler(value = "job-method-two2", name = "方法任务处理器two2")
    public void handlerTwo2(JobHandlerParam jobParam) {
        log.info("JobHandlerOne 处理任务, 任务参数 {}", jobParam.getParams());
    }
}
